...
<body>
	...
	<h2>Register Your Account Here</h2>
		...
		<form class="form-horizontal" method="post" action="addstaffSoS.php">
<form>
	<div class="inputBox">
	...
	<div class="inputBox">
			    <input type="email" placeholder="email@gmail.com" class="form-control input-md" name="email" required="required"/>
                  <label>Email</label>
			   </div>
